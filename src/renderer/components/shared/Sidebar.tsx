    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <Link className="sidebar-brand brand-logo-mini" to="/dashboard"><img src={logo_mini} alt="logo" /></Link>
        </div>
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>{window.ME ? window.ME.name : 'Henry Klein'}</Trans></h5>
                  <span><Trans>{window.ME ? window.ME.member : 'Gold Member'}</Trans></span>
                </div>
              </div>
              <Dropdown align="end">
          ...
          <li className={this.isPathActive('/error-pages') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
            ...
            <Collapse in={this.state.errorPagesMenuOpen}>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={this.isPathActive('/error/404') ? 'nav-link active' : 'nav-link'} to="/error/404">404</Link></li>
                  <li className="nav-item"> <Link className={this.isPathActive('/error/500') ? 'nav-link active' : 'nav-link'} to="/error/500">500</Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
          <li className="nav-item menu-items">
            <a className="nav-link" href="###/documentation.html" rel="noopener noreferrer" target="_blank">
              <span className="menu-icon">
