                ...
                <div className="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item"><a href="!#" onClick={(evt: React.MouseEvent<HTMLElement>) => evt.preventDefault()}>Apps</a></li>
...
export class TodoListComponent extends Component<any, any> {
    ...
    statusChangedHandler(event: React.ChangeEvent<HTMLInputElement>, id: number) {
                    ...
                    <ul className="d-flex flex-column todo-list">
                        {this.state.todos.map((todo: any, index: number) => {
                            return <ListItem
                                ...
                                changed={(event: React.ChangeEvent<HTMLInputElement>) => this.statusChangedHandler(event, index)}
                                key={todo.id}
